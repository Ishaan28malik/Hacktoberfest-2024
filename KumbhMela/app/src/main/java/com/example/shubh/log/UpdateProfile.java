...
public class UpdateProfile extends AppCompatActivity {
    ...
    private EditText newUserName, newUserEmail, newUserAge,newcomment;
    private Button save;
   ...
   // String comment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // newcomment=findViewById(R.id.etfback);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                //newcomment.setText(userProfile.getComment());
            }
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String comment="profile updated!add new comment";
              ...
              /* Intent k=new Intent(UpdateProfile.this,MainActivity.class);
                startActivity(k);*/
