...
public class camp extends AppCompatActivity {
    ...
    public void open()
    {
        b1=(ImageButton)findViewById(R.id.imageButtonc);
        b2=(ImageButton)findViewById(R.id.imageButton2c);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String url="http://www.thekumbhallahabad.com/deluxe-tents/";
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // String url="https://www.tourmyindia.com/kumbhmela/";
                String url="https://www.youtube.com/watch?v=4h8-I3VbwOE";
                // w1.getSettings().setLoadsImagesAutomatically(true);
                Intent myIntent = new Intent(Intent.ACTION_VIEW);
                myIntent.setData(Uri.parse(url));
                startActivity(myIntent);
