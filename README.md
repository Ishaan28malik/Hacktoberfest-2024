...
| InfraCloud | ![Shirt](icons/tshirt.png) ![Stickers](icons/stickers.png) | "one or more merged PRs on [Fission](https://github.com/fission/fission) or [BotKube](https://github.com/infracloudio/botkube) or both. [Notes]:Only the first 50 people will receive the swags." | [Details](https://www.infracloud.io/blogs/infracloud-joins-hacktoberfest-2020/)
