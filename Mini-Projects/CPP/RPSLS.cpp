...
Tasks
    ...
    a. Prompts the user to select either Rock, Paper, Scissors, Lizard, or Spock.
    b. Instructs the computer to randomly select either Rock, Paper, Scissors, Lizard, or Spock.
    c. Compares the user’s choice and the computer’s choice and determine the winner.
    d. Informs the user who the winner is.

This is the infamous game brought to popularity with the TV show The Big Bang Theory.

Youtube Link : https://www.youtube.com/watch?v=iSHPVCBsnLw
